// src/pages/Memory/MemoryPagePreview.tsx
// Acesse em /preview-memoria para editar o visual em tempo real
// REMOVA essa rota antes do deploy em produção

import { useEffect, useRef, useState } from 'react'

const FAKE_MEMORY = {
  slug: 'nossa-primeira-viagem-k3x9p2',
  title: 'Nossa primeira viagem',
  date: '2022-02-14',
  text: 'Aquela semana em Lisboa onde tudo começou de verdade. O fado, o vinho, o sol de setembro e você do meu lado em cada esquina daquela cidade mágica Aquela semana em Lisboa onde tudo começou de verdade. O fado, o vinho, o sol de setembro e você do meu lado em cada esquina daquela cidade mágica Aquela semana em Lisboa onde tudo começou de verdade. O fado, o vinho, o sol de setembro e você do meu lado em cada esquina daquela cidade mágica Aquela semana em Lisboa onde tudo começou de verdade. O fado, o vinho, o sol de setembro e você do meu lado em cada esquina daquela cidade mágica Aquela semana em Lisboa onde tudo começou de verdade. O fado, o vinho, o sol de setembro e você do meu lado em cada esquina daquela cidade mágica Aquela semana em Lisboa onde tudo começou de verdade. O fado, o vinho, o sol de setembro e você do meu lado em cada esquina daquela cidade mágica.',
  bgColor: '#1a0a1a',
  spotifyUrl: 'https://open.spotify.com/track/3n3Ppam7vgaVa1iaRUIOKE',
  photos: [
  ...
  return (
    <div className="px-5">
      ...
      <div className="bg-white rounded-2xl p-3 pb-10 shadow-2xl">
        {/* Área da foto com overflow hidden e cantos arredondados */}
        ...
        {/* Espaço inferior do polaroid — clássico */}
...
export function MemoryPagePreview() {
    ...
    <div className="min-h-screen text-white" style={{ background: memory.bgColor, fontFamily: 'sans-serif' }}>
      <div className="max-w-lg mx-auto pb-16">
        ...
        <div className="px-5">
          ...
          {/* Contador */}
          <div className="mt-5 rounded-xl px-4 py-3 text-center text-[13px] font-semibold tracking-wide"
