...
function PhotoCarousel({ photos, frameStyle }: { photos: string[]; frameStyle: string }) {
  ...
  const wrapperStyle: React.CSSProperties =
    frame === "polaroid"
      ...
      : frame === "vintage"
      ? { background: "#f5e6c8", borderRadius: 8, padding: "10px 10px 36px", boxShadow: "0 4px 20px rgba(0,0,0,0.5)", filter: "sepia(0.3)" }
      : frame === "minimalista"
      ? { borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }
      : frame === "neon"
      ? { borderRadius: 16, padding: 3, background: "linear-gradient(135deg, #7c6aff, #b06fff, #ff6aff)", boxShadow: "0 0 20px rgba(124,106,255,0.6), 0 0 40px rgba(176,111,255,0.3)" }
      : { background: "#fff", borderRadius: 16, padding: "12px 12px 40px", boxShadow: "0 8px 32px rgba(0,0,0,0.4)" };
        ...
        <div style={frame === "neon" ? { ...wrapperStyle, animation: "neon-glow 2s ease-in-out infinite" } : wrapperStyle}>
          <div style={innerStyle}>
            <div
              ...
              style={frame === "neon" || frame === "minimalista" ? { borderRadius: frame === "neon" ? 14 : 16 } : {}}
            >
              <div
          ...
          <div className="px-5">
            ...
            <div className="flex items-start gap-2.5 mt-6">
              ...
              <h1
                ...
                style={{
                  fontFamily:
                    memory.fontStyle === "serifada" ? "Georgia, serif"
                    : memory.fontStyle === "manuscrita" ? "Caveat, cursive"
                    : "DM Sans, sans-serif",
                }}
              >
                {memory.title}
            ...
            <p
              ...
              style={{
                ...
                fontFamily:
                  memory.textFont === "serifada" ? "Georgia, serif"
                  : memory.textFont === "manuscrita" ? "Caveat, cursive"
                  : "DM Sans, sans-serif",
              }}
            >
              {memory.text}
            ...
            <div className="mt-12 pt-4 flex items-center justify-between" style={{ borderTop: "1px solid rgba(255,255,255,0.07)" }}>
              <div className="flex items-center gap-1.5">
                <div className="w-[22px] h-[22px] rounded-md flex items-center justify-center flex-shrink-0" style={{ background: "linear-gradient(135deg, #7c6aff, #b06fff)" }}>
